...
<div class="news-scroll" role="region" aria-label="Recent news">
  <ul class="news-list">
    ...
    <li>
      🎉 <a href="https://dl.acm.org/doi/10.1145/3746027.3755112">Latent Diffusion Unlearning: Protecting Against Unauthorized Personalization Through Trajectory Shifted Perturbations</a> is accepted at <strong>ACM MM 2025</strong>!
      <ul>
        <li>(with: Adobe Research, <a href="https://arc.net/l/quote/sfgeqwly">CVG at UMBC</a>).</li>
      </ul>
    </li>
    <!-- <li>
      <a href="#">Hallucination Mitigation in Diffusion Models.</a>
      <ul>
        <li>(with: <a href="https://cse.buffalo.edu/~doermann/index.html">Dr. David Doermann</a>). <em>(Under Review)</em></li>
      </ul>
    </li> -->
  </ul>
</div>
